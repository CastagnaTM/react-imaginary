        ...
        if(this.state.instructions === 'B'){
            return(
                <div className='instructions'>
                    ...
                    <h4 id="user-page-font">Your current score on the left shows the number of friends you've made without losing, and your high score shows the most friends you've made in a row</h4>
